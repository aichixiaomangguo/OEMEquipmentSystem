...
public class EquipModel implements Serializable {
    ...
    public EquipModel(String imei, String model, String os, String cpu, String memory, String storage, String resolution, String responsible, int source, String manufacturer, int state) {
        this.imei = imei;
        this.model = model;
        this.os = os;
        this.cpu = cpu;
